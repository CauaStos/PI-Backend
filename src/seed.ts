...
async function seed(): Promise<void> {
    ...
    const employees = await Employee.create([
        { name: "Joao Pires", email: "joaopires@emaildash.com", role: "admin", avatar: "J" },
        { name: "Mariana Cardoso", email: "mariana@emaildash.com", role: "garcom", avatar: "M" },
        { name: "Mateus Silva", email: "mateus@emaildash.com", role: "garcom", avatar: "M" },
        { name: "Ana Julia", email: "ana@emaildash.com", role: "cozinha", avatar: "A" },
    ]);
